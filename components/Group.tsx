...
export default function Group({ id, name, uni_name, gender, dim1, dim2, dim3, dim4 }: Props) {
  ...
  return (
    ...
    <LinearGradient
      ...
      start={{ x: -0.4, y: 0 }}
    >
        {openProfile && <Profile openProfile={openProfile} setOpenProfile={setOpenProfile} id={id ?? "1"} similarity={-1}/>}
