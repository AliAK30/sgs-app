...
export const questions: Array<Array<Question>> = [
  [
    ...
    },
    {
      ...
      number: 6,
      section: 1,
      a: "I would love to deal with facts and real life situations only facts 📢",
    ...
    },
    {
      ...
      number: 8,
      section: 1,
      a: "Discuss the part of the algorithm and then conclude it with the whole structure (Monolithic Approach) (For Example in case Divide and Conquer Approach first discuss decide model and conquer module and the whole algorithm of merge sort) ➗",
      b: "Discuss the whole algorithms and then part individual working of the modules (Modular Approach) (For Example in case Divide and Conquer Approach First discuss the merge sort completely then discuss divide and conquer module) 🧩",
  ...
  [
    ...
    {
      question: "When I have solve the problem:",
      number: 8,
      section: 3,
      a: "I prefer to master of one way doing it 🎯",
    ...
    {
      question: "When approaching a collaborative algorithm development task:",
      number: 11,
      section: 3,
      a: "Conduct a 'Group Brainstorming'  session, allowing everyone to contribute ideas collaboratively 👥 ",
      b: "Individually brainstorm algorithmic  solutions, then convene as a group to compare and refine the ideas 💻",
  ...
  [
    {
      ...
      number: 1,
      section: 4,
      a: "Sensible-Think logically, resolve issues, efficient communication abilities knows ethics 💭",
      b: "Imaginative-Creative Thinking, interest in fantasy and fiction, accept new experiences 🔮",
    ...
    },
    {
      ...
      number: 4,
      section: 4,
      a: "Outgoing includes highly social, confident, build relations 🤝",
      b: "Reserved includes Less Social, Think before speak, Not express feeling openly, Good listener 🤫",
